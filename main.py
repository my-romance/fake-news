...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_file", default="news_train_temp.tsv", type=str, help="Train file")
    parser.add_argument("--test_file", default="news_test_temp.tsv", type=str, help="Test file")
    ...
    parser.add_argument("--max_title_len", default=50, type=int, help="The maximum title input sequence length after tokenization.")
    parser.add_argument("--max_sentence_len", default=100, type=int, help="The maximum sentence of contents input sequence length after tokenization.")
